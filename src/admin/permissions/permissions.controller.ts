...
export class PermissionsController {
  ...
  @ApiOperation({
    summary: 'Aktif Yetkileri Getir',
    description: 'Soft delete yapılmamış olan tüm aktif yetkileri getirir.',
  })
  @ApiResponse({
    status: 200,
    description: 'Yetkiler başarıyla alındı.',
    type: [ActiveAllPermissionsResponseDto],
  })
  findAll(
    @Query('page') page: number = 1,
    @Query('limit') limit: number = 10,
  ): Promise<{
    permissions: ActiveAllPermissionsResponseDto[];
    total: number;
    totalPages: number;
  }> {
  ...
  @Permissions('admin_read_roles')
  @ApiOperation({
    summary: 'Pasif Yetkileri Getir',
    description: 'Soft delete yapılmış olan tüm pasif yetkileri getirir.',
  })
  @ApiResponse({
    status: 200,
    description: 'Yetkiler başarıyla alındı.',
    type: [InactiveAllPermissionsResponseDto],
  })
  findAllInactive(
    @Query('page') page: number = 1,
    @Query('limit') limit: number = 10,
  ): Promise<{
    permissions: InactiveAllPermissionsResponseDto[];
    total: number;
    totalPages: number;
  }> {
  ...
  @Permissions('admin_read_roles')
  @ApiOperation({
    summary: 'Tüm Yetkileri Getir',
    description: 'Soft delete yapılmış olanlar dahil tüm yetkileri getirir.',
  })
  @ApiResponse({
    status: 200,
    description: 'Yetkiler başarıyla alındı.',
    type: [FindAllPermissionsResponseDto],
  })
  ...
  @Permissions('admin_read_roles')
  @ApiOperation({
    summary: 'Yetki Detayını Getir',
    description: "Belirtilen ID'ye sahip yetkiyi getirir.",
  })
  @ApiParam({
    name: 'id',
    description: "Yetki ID'si",
    example: 'd290f1ee-6c54-4b01-90e6-d701748f0851',
  })
  @ApiResponse({
    status: 200,
    description: 'Yetki başarıyla alındı.',
    type: GetByIdPermissionsResponseDto,
  })
  ...
  @ApiOperation({
    summary: 'Yeni Yetki Ekle',
    description: 'Yeni bir yetki ekler.',
  })
  ...
  @UseInterceptors(AuditLogInterceptor)
  @ApiOperation({
    summary: 'Yetkiyi Güncelle',
    description: "Belirtilen ID'ye sahip yetkiyi günceller.",
  })
  @ApiParam({
    name: 'id',
    description: "Yetki ID'si",
  ...
  @ApiResponse({
    status: 200,
    description: 'Yetki başarıyla güncellendi.',
  ...
  @UseInterceptors(AuditLogInterceptor)
  @ApiOperation({
    summary: 'Yetkiyi Soft Delete Yap',
    description: "Belirtilen ID'ye sahip yetkiyi soft delete yapar.",
  })
  @ApiParam({
    name: 'id',
    description: "Yetki ID'si",
  ...
  @UseInterceptors(AuditLogInterceptor)
  @ApiOperation({
    summary: 'Pasif Yetkiyi Geri Yükle',
    description: 'Soft delete yapılmış bir yetkiyi geri yükler.',
  })
  @ApiParam({
    name: 'id',
    description: "Yetki ID'si",
  ...
  @UseInterceptors(AuditLogInterceptor)
  @ApiOperation({
    summary: 'Yetkiyi Kalıcı Olarak Sil',
    description: "Belirtilen ID'ye sahip yetkiyi kalıcı olarak siler.",
  })
  @ApiParam({
    name: 'id',
    description: "Yetki ID'si",

...
export class AdminRolesService {
  ...
  async findAll(
    ...
    return {
      roles: roles.map((role) =>
        this.modelMapper.mapToDto(role, ActiveAllRolesResponseDto),
      ),
      total,
      totalPages,
    };
  ...
  async findAllInactive(
    ...
    return {
      roles: roles.map((role) =>
        this.modelMapper.mapToDto(role, InactiveAllRolesResponseDto),
      ),
      total,
      totalPages,
    };
  ...
  async findByIds(roleIds: string[]): Promise<FindByIdsRolesResponseDto[]> {
    ...
    const rolesDto = roles.map((role) =>
      this.modelMapper.mapToDto(role, FindByIdsRolesResponseDto),
    );
    return rolesDto;
  }
  ...
  async findAllIncludingDeleted(
    ...
    return {
      roles: roles.map((role) =>
        this.modelMapper.mapToDto(role, FindAllRolesResponseDto),
      ),
      total,
      totalPages,
    };
  ...
  async create(
    ...
    const newRole = this.modelMapper.mapToEntity(
      createRoleDto,

...
export class AdminRolesController {
  ...
  @ApiOperation({
    summary: 'Aktif Rolleri Getir',
    description: 'Soft delete yapılmamış olan tüm aktif rolleri getirir.',
  })
  @ApiResponse({
    status: 200,
    description: 'Roller başarıyla alındı.',
    type: [ActiveAllRolesResponseDto],
  })
  findAll(
    @Query('page') page: number = 1,
    @Query('limit') limit: number = 10,
  ): Promise<{
    roles: ActiveAllRolesResponseDto[];
    total: number;
    totalPages: number;
  }> {
  ...
  @Permissions('admin_read_roles')
  @ApiOperation({
    summary: 'Pasif Rolleri Getir',
    description: 'Soft delete yapılmış olan tüm pasif rolleri getirir.',
  })
  @ApiResponse({
    status: 200,
    description: 'Pasif roller başarıyla alındı.',
    type: [InactiveAllRolesResponseDto],
  })
  findAllInactive(
    @Query('page') page: number = 1,
    @Query('limit') limit: number = 10,
  ): Promise<{
    roles: InactiveAllRolesResponseDto[];
    total: number;
    totalPages: number;
  }> {
  ...
  @ApiOperation({
    ...
    description: 'Soft delete yapılmış olanlar dahil tüm rolleri getirir.',
  })
  @ApiResponse({
    status: 200,
    description: 'Roller başarıyla alındı.',
    type: [FindAllRolesResponseDto],
  })
  findAllIncludingDeleted(
    @Query('page') page: number = 1,
    @Query('limit') limit: number = 10,
  ): Promise<{
    roles: FindAllRolesResponseDto[];
    total: number;
    totalPages: number;
  }> {
  ...
  @ApiOperation({
    ...
    description: "Belirtilen ID'ye sahip rolü getirir.",
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiResponse({
    status: 200,
    description: 'Rol başarıyla alındı.',
    type: GetByIdRolesResponseDto,
  })
  ...
  @ApiOperation({
    ...
    description: 'Yeni bir rol ekler.',
  })
  ...
  @ApiOperation({
    ...
    description: "Belirtilen ID'ye sahip rolü günceller.",
  })
  @ApiParam({
    name: 'id',
    description: "Rol ID'si",
  ...
  @UseInterceptors(AuditLogInterceptor)
  @ApiOperation({
    summary: 'Rolü Soft Delete Yap',
    description: "Belirtilen ID'ye sahip rolü soft delete yapar.",
  })
  @ApiParam({
    name: 'id',
    description: "Rol ID'si",
  ...
  @ApiResponse({
    status: 204,
    description: 'Rol başarıyla pasif hale getirildi.',
  })
  ...
  @UseInterceptors(AuditLogInterceptor)
  @ApiOperation({
    summary: 'Pasif Rolü Geri Yükle',
    description: 'Soft delete yapılmış bir rolü geri yükler.',
  })
  @ApiParam({
    name: 'id',
    description: "Rol ID'si",
  ...
  @UseInterceptors(AuditLogInterceptor)
  @ApiOperation({
    summary: 'Rolü Kalıcı Olarak Sil',
    description: "Belirtilen ID'ye sahip rolü kalıcı olarak siler.",
  })
  @ApiParam({
    name: 'id',
    description: "Rol ID'si",
  ...
  @ApiResponse({
    status: 204,
    description: 'Rol başarıyla kalıcı olarak silindi.',
  })

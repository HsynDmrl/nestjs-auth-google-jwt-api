...
export class AdminUsersController {
  ...
  @ApiOperation({
    summary: 'Aktif Kullanıcıları Getir',
    description: 'Tüm aktif kullanıcıları getirir.',
  })
  @ApiResponse({
    status: 200,
    description: 'Kullanıcılar başarıyla alındı.',
    type: [ActiveAllAdminUsersResponseDto],
  })
  findAll(
  ...
  @Permissions('admin_read_users')
  @ApiOperation({
    summary: 'Pasif Kullanıcıları Getir',
    description: 'Soft delete yapılmış tüm pasif kullanıcıları getirir.',
  })
  @ApiResponse({
    status: 200,
    description: 'Pasif kullanıcılar başarıyla alındı.',
    type: [User],
  })
  findAllInactive(
    @Query('page') page: number = 1,
  ...
  @ApiOperation({
    ...
    description: 'Tüm kullanıcıları getirir, silinmiş kullanıcılar da dahil.',
  })
  @ApiResponse({
    status: 200,
    description: 'Tüm kullanıcılar başarıyla alındı.',
    type: [FindAllAdminUsersResponseDto],
  })
  ...
  @ApiResponse({
    ...
    type: GetByIdAdminUsersResponseDto,
  })
  ...
  @ApiResponse({
    ...
    type: CreateAdminUsersResponseDto,
  })
  create(
    @Body() createAdminUserDto: CreateAdminUserRequestDto,
  ...
  update(
    @Param('id') id: string,
    @Body() updateRoleDto: UpdateAdminUserRequestDto,
  ...
  @UseInterceptors(AuditLogInterceptor)
  @ApiOperation({
    summary: 'Kullanıcıyı Soft Delete Yap',
    description: "Belirtilen ID'ye sahip kullanıcıyı soft delete yapar.",
  })
  @ApiParam({
    name: 'id',
    description: 'Kullanıcı ID',
  ...
  @UseInterceptors(AuditLogInterceptor)
  @ApiOperation({
    summary: 'Pasif Kullanıcıyı Geri Yükle',
    description: 'Soft delete yapılmış kullanıcıyı geri yükler.',
  })
  @ApiParam({
    name: 'id',
    description: 'Kullanıcı ID',
  ...
  @ApiResponse({
    status: 200,
    description: 'Kullanıcı başarıyla geri yüklendi.',
  })
  ...
  @UseInterceptors(AuditLogInterceptor)
  @ApiOperation({
    summary: 'Kullanıcıyı Kalıcı Olarak Sil',

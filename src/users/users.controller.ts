...
export class UsersController {
  ...
  @ApiOperation({
    ...
    description: "Belirtilen ID'ye sahip kullanıcı profilini günceller.",
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiResponse({
    status: 200,
    description: 'Kullanıcı başarıyla soft delete yapıldı.',
  })
  ...
  @ApiOperation({
    summary: 'Kullanıcıyı E-posta ile Getir',
    description: 'Belirtilen e-posta adresine sahip kullanıcıyı getirir.',
  })
  @ApiParam({
    name: 'email',
